...
namespace App1
{
    public partial class MainPage : LayoutAwarePage
    {
        ...
        {
            new Scenario() { Title = "Using Direct2D SharpDX", ClassType = typeof(BlankPage1) },
            new Scenario() { Title = "Using Win2d", ClassType = typeof(Win2DPage) }
        };
    }
